      ...
      blocks: [
        {
          type: 'list',
          items: [
            'Filtre, der ikke kan give data på den aktuelle side, er nu skjult, og dem, du allerede har anvendt, vises som inaktive.',
...
export const latestChangelogModalDa = v146ChangelogEntryDa;
