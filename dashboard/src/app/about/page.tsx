    ...
    <div className='container mx-auto max-w-4xl px-4 py-32'>
      <div className='mb-12 text-center'>
        ...
        <p className='text-muted-foreground mx-auto max-w-3xl text-xl leading-relaxed'>
          We're building the future of web analytics: privacy-first, open source, and designed for the modern web.
          No more choosing between powerful insights and respecting your visitors' privacy.
        </p>
      </div>
      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            Betterlytics was born out of real frustration. Our team was developing a Vendor Management System when
            we hit a wall with web analytics. Every solution we evaluated forced us into the same impossible
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            What started as a solution for our own needs became something much bigger: a mission to build analytics
            tools that respect both website owners and their visitors. Every feature is designed with privacy and
            performance as equal priorities.
          </p>
        </section>
        ...
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            The web analytics industry has been dominated by surveillance capitalism for too long. Major analytics
            providers collect vast amounts of personal data, track users across websites, and use this information
            to build detailed behavioral profiles for advertising purposes.
          </p>
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            We don't believe website owners should have to compromise their visitors' privacy to understand how
            their site performs. Betterlytics collects only the essential metrics you need: no cookies, no personal
            data, no cross-site tracking. Your visitors' privacy is respected by default.
          </p>
        </section>
        ...
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            Betterlytics is completely open source under the AGPL-3.0 license. This isn't just about transparency,
            it's about accountability. Anyone can inspect our code, verify our privacy claims, and contribute to
        ...
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            ...
            as your visitors' privacy. Our tracking script weighs less than 2KB. Compare that to Google Analytics'
            bloated 45KB+ payload. Built with modern web standards and optimized for speed, Betterlytics won't slow
            down your site.
          </p>
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
        ...
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            Whether you're running a personal blog, a growing SaaS platform, an e-commerce store, or an enterprise
            website, Betterlytics is designed to meet your needs. We understand that different organizations have
            different requirements, from simple traffic insights to complex user journey analysis.
          </p>
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            Integration takes minutes, not hours. Our dashboard is intuitive and well-documented, showing you what
            you need to know without drowning you in unnecessary complexity. While we don't have a public API yet,
            every dashboard feature is thoroughly documented to help you get the most out of your analytics.
          </p>
        </section>
        ...
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            ...
            We're funded by our users, not by selling their data. This alignment of incentives ensures we'll always
            prioritize privacy and performance and never compromise on either.
          </p>
        </section>
        ...
        <section className='mb-12'>
          ...
          <p className='text-muted-foreground mb-6 text-lg leading-relaxed'>
            This vision drives everything we build. Every feature, every optimization, every decision is guided by
            our commitment to privacy-first analytics that everyone can trust and use.
          </p>
        </section>
