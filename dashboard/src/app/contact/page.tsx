...
const CONTACT_METHODS = [
  {
    icon: Mail,
    title: 'Email',
    description: 'hello@betterlytics.com',
    href: 'mailto:hello@betterlytics.com',
  },
  {
    icon: GitHubIcon,
    title: 'GitHub',
      ...
      <div className='mb-16'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Whether you need technical support, have questions about our features, or want to discuss enterprise
              solutions, we're here to help. Choose the method that works best for you:
            </CardDescription>
          </CardHeader>
