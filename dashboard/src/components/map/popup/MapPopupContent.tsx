...
function MapPopupContentComponent({
  ...
  return (
    <div
      ...
      className={cn(
        'border-border bg-popover/95 text-foreground pointer-events-auto flex min-w-[200px] flex-col space-y-1 rounded-lg border p-3 text-sm shadow-xl backdrop-blur-sm',
