...
export const FILTER_COLUMN_SELECT_OPTIONS: FilterColumnSelectOptions = [
  ...
  { value: 'browser_version', icon: <HashIcon />, label: 'Browser version' },
  { value: 'os', icon: <MonitorSmartphoneIcon />, label: 'Operating system' },
  { value: 'os_version', icon: <BinaryIcon />, label: 'OS version' },
  { value: 'custom_event_name', icon: <SunsetIcon />, label: 'Event' },
  { value: 'outbound_link_url', icon: <ExternalLinkIcon />, label: 'Outbound link' },
  ...
  { value: 'referrer_url', icon: <Link2 />, label: 'Referrer URL' },
