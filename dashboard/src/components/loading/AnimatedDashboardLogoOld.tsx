...
interface AnimatedDashboardLogoOldProps {
  size?: number;
  className?: string;
}

export const AnimatedDashboardLogoOld = memo(function AnimatedDashboardLogoOld({
  size = 80,
  className = '',
}: AnimatedDashboardLogoOldProps) {
  const id = useId();
  const maskId = `logoMaskOld-${id}`;
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <mask id={maskId}>
            <rect x='0' y='0' width='375' height='1069' fill='white' className='animate-fill-up-old-1' />
            <rect x='375' y='0' width='375' height='1069' fill='white' className='animate-fill-up-old-2' />
            <rect x='750' y='0' width='321' height='1069' fill='white' className='animate-fill-up-old-3' />
          </mask>
        </defs>
      ...
      <style jsx>{`
        ...
        .animate-fill-up-old-1,
        .animate-fill-up-old-2,
        .animate-fill-up-old-3 {
          will-change: transform;
          backface-visibility: hidden;
        }

        .animate-fill-up-old-1 {
          animation: fill-up-old 1.8s cubic-bezier(0.4, 0, 0.2, 1) infinite;
        }
