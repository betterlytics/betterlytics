...
export default function BATopbar() {
  ...
  return (
    <>
      <header className='bg-background/95 supports-[backdrop-filter]:bg-background/60 fixed top-0 left-0 z-50 w-full border-b shadow-md shadow-black/5 backdrop-blur-md dark:shadow-white/8'>
