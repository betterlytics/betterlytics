...
export function toNewStackedAreaChart<CategoryKey extends string, ValueKey extends string>(
  props: ToStackedAreaChartProps<CategoryKey, ValueKey>,
  ...
  const { compare, compareDateRange, categoryKey, valueKey, granularity, timezone } = props;
