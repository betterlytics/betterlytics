...
export const METRICS = [
  ...
  { key: 'avg_scroll_depth', description: 'Average scroll depth percentage', expression: safeSql`avgIf(scroll_depth_percentage, event_type = 'engagement' AND scroll_depth_percentage IS NOT NULL) as avg_scroll_depth` },
