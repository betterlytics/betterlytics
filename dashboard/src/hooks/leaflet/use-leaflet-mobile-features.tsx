...
// import { LeafletStyleProps, useLeafletStyle } from './use-leaflet-style';
...
// export function useLeafletMobileFeatures({
//   visitorData,
//   style,
//   size,
//   calculatedMaxVisitors,
// }: UseLeafletFeaturesProps) {
//   //! TODO: Probably need to provide the leaflet-visitor globally within map-container so we can modify it everywhere
//   const visitorRef = useRef<LeafletVisitor | undefined>(undefined);
//   style ??= useLeafletStyle({ calculatedMaxVisitors, size });
//   useEffect(() => {
...
//       selectFeature(visitorRef.current.geoVisitor, visitorRef.current.layer);
//     } else {
