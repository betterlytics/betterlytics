...
When enabled, the Betterlytics tracking script is added to the footer of your site's pages and starts recording. When disabled, the script is left out of the page entirely, not merely inert but absent from the source, sending nothing.
