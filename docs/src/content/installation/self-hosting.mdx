...
Core Web Vitals works out of the box: enable it with `data-web-vitals="true"` on your tracking script and all scripts are served by your instance itself - no third-party requests. See the [Web Vitals integration guide](/integration/web-vitals).
