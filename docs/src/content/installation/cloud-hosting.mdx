...
description: "Get started with Betterlytics Cloud in under a minute. Create an account, install the tracking script, and see your first data within minutes."
---
...
Get started with our hosted service in under 60 seconds.
