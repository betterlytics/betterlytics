...
{/* TODO: Add screenshot of monitoring list page - 5 monitors with different endpoints such as https://example.com, https://example.com/api/health etc. */}
...
{/* TODO: Add screenshot of incident table with some resolved and one ongoing or something like that */}
...
- **Response time chart**: P50, P95, and average latency over time
