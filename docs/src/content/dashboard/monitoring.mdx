---
title: "Uptime Monitoring & SSL Certificate Checks"
...
**Related**: Share your uptime publicly with a [Status Page](/dashboard/status-pages), or compare [pricing plans](/pricing) to see monitor limits and advanced features.
