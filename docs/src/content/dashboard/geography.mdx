...
<Callout type="info">
This threshold is a display-level safeguard. City data is still stored (IP addresses are discarded at ingestion), but the dashboard won't surface rows that could enable singling out.
</Callout>
