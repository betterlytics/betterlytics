...
<div style={{ textAlign: "center", margin: "20px 0" }}>
  ![Public Status Page Hero View](/images/dashboard/status-page-public-view.webp)
</div>
...
<div style={{ textAlign: "center", margin: "20px 0" }}>
  ![Status Page Studio with Live Preview](/images/dashboard/status-page-studio.webp)
</div>
...
On a self-hosted instance the page lives at `https://<your-domain>/status/{your-slug}` instead.
