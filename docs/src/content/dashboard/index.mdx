...
- **Chart Annotations** - Mark launches, deploys, or campaigns directly on the chart, so you can connect traffic changes to real-world events
...
Each of the five summary tables (Top Pages, Geography, Devices Breakdown, Traffic Sources, and Events) features its own set of tabs.
...
#### Events
- **Custom Events**: Your custom tracked events (button clicks, form submissions, etc.), ranked by number of occurrences
- **Global Properties**: Key-value metadata attached to all events (e.g. plan, role, app version), ranked by unique visitors. See [Global Properties](/integration/global-properties) for setup instructions.
...
<DashboardSectionGrid>
  ...
  <DashboardSectionCard
    ...
    description="UTM campaign tracking and marketing attribution across all traffic sources."
  />
  ...
  <DashboardSectionCard
    ...
    description="Client-side JavaScript error capture with stack traces and session replay links."
  />
  ...
  <DashboardSectionCard
    ...
    description="Public status pages with live uptime, incident timelines, and custom branding."
  />

  <DashboardSectionCard
    title="Email Reports"
    href="/dashboard/email-reports"
    description="Scheduled weekly or monthly analytics summaries delivered to your inbox."
  />

  <DashboardSectionCard
    title="Notifications"
    href="/dashboard/integrations"
    description="Slack, Discord, Teams, and webhook alerts for monitoring and uptime events."
  />

  <DashboardSectionCard
    title="MCP Server"
    href="/dashboard/mcp"
    description="Query your analytics via AI assistants using the built-in MCP integration."
  />
