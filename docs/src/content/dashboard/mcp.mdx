...
description: "Connect AI assistants to your Betterlytics analytics data using the Model Context Protocol (MCP)."
---
...
Betterlytics exposes your analytics data through a [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) server. This lets you ask AI assistants about your website's traffic in natural language. No dashboards or manual queries needed.
