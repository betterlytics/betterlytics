...
- **Event** - Specific custom event names (see [Custom Events documentation](https://betterlytics.io/docs/integration/custom-events))

**Global Properties**
- **Custom JSON properties** - Filter by any property you've attached via global properties (see [Global Properties documentation](https://betterlytics.io/docs/integration/global-properties))

**Outbound Links**
- **Outbound link** - The destination URL of an outbound link click (see [Outbound Links documentation](https://betterlytics.io/docs/dashboard/outbound-links))
...
**Affiliate Click-Through Funnel:**
1. URL is `/reviews/*` (matches any review page)
2. Outbound link is `*partner.com*` (matches outbound clicks to a partner domain)
...
- Verify that [custom events](https://betterlytics.io/docs/integration/custom-events) are triggering at the right time
