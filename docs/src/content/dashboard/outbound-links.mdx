...
<div style={{ textAlign: "center", margin: "20px 0" }}>
  ![Outbound Links Charts And Tables](/images/dashboard/outbound-links-charts-and-tables.webp)
</div>
...
- **Domain**: only the origin is captured (example: `https://example.com`)
- **Full**: origin + path is captured (example: `https://example.com/blog/some-article`)
