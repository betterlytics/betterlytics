...
- Retention: 60 days on Betterlytics Cloud. Self-hosted instances set their own retention with [`REPLAY_RETENTION_DAYS`](/installation/self-hosting#session-replay). After expiration, sessions are permanently deleted and cannot be recovered.
