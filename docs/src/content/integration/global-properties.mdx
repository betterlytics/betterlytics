...
**Good candidates:**
- Subscription plan or tier (`plan: "pro"`)
- User role (`role: "admin"`)
- App or release version (`app_version: "2.1.0"`)
- Feature flag state (`new_checkout: true`)
- Environment (`environment: "production"`)
- Experiment cohort (`experiment: "variant-b"`)
...
Global property filters work at the session level. A session is included if the property matched at any point during that visit, and all of its metrics count in full. See [Global property filters](/dashboard/filtering#global-property-filters) for a full explanation of what this means for your metrics.
