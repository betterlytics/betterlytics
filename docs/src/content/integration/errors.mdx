...
<Callout type="info">
**Availability**: Error Tracking is live on Betterlytics Cloud. It is not yet included in the current self-hosted image and will arrive with a later image update. See [how self-hosted releases work](/installation#how-self-hosted-releases-work).
</Callout>
