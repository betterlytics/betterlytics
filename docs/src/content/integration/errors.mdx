...
description: "Enable client-side JavaScript error tracking with Betterlytics. Catch errors automatically, link them to session replays, and debug issues faster."
---
...
<Callout type="info">
**Availability**: Error Tracking is live on Betterlytics Cloud. It is not yet included in the current self-hosted image and will arrive with a later image update. See [feature availability for self-hosting](/installation/self-hosting#feature-availability).
</Callout>
