...
Normalize dynamic URLs containing user IDs, session tokens, or other variable parameters into consistent patterns. This improves privacy by removing identifying information and creates more meaningful analytics by grouping similar pages together.
