...
For geolocation to work, set `ENABLE_GEOLOCATION=true` and add your MaxMind credentials to `.env`. For city and subdivision drill-down, also set `PUBLIC_ENABLE_GEOSUBDIVISION=true`.
