...
For geolocation to work, set `ENABLE_GEOLOCATION=true` and add your MaxMind credentials to `.env`. For city and subdivision drill-down, also set `GEOLOCATION_MODE=full`.
